...
- **複製給 AI 解讀**:整盤資料、單一宮位深度分析(12 宮各含問題與判讀順序)、指定流年分析、姓名學四種提示詞,一鍵複製貼給任何對話式 AI
- **流年運勢提醒**:已有存檔命盤時,進站直接看到「今年運勢」提醒卡,一鍵跳去看今年的大限流年重點,不用重新輸入生辰
- **命盤比對**:勾選 2–4 筆已存命盤並排比較命宮主星、五行局、日主喜忌與今年流年
- **姓名學**:五格剖象法(天格/人格/地格/外格/總格 + 三才五行生剋傾向)、姓名五行 × 八字喜用神 × 紫微命宮主星比對,自動帶入排盤姓名(約 700+ 常用姓名用字字典)
- **命理小百科**:63+ 詞條的紫微/八字名詞辭典,含常見命盤組合與示範案例解讀,獨立靜態頁面(SEO 友善)
